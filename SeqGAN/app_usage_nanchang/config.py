...
DATA_DIR = os.path.join(BASE_DIR, '..', '..', 'data', 'app_usage', 'nanchang', 'derived')
...
# geographic bounds of the study area (1st-99th percentile bbox of app_usage/nanchang/location.csv)
LON_MIN = 115.56804867
LON_MAX = 116.37840291
LAT_MIN = 28.28989124
LAT_MAX = 28.92117133
GRID_ROWS = 20
GRID_COLS = 20
